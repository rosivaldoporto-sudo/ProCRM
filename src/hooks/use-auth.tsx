...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const fetchProfile = useCallback(async (userId: string, userEmail = '') => {
    ...
    try {
      ...
      if (data) {
        ...
        setProfile({
          ...
          // Email comes from the caller's signed Auth user, not the shared
          // profiles table. This lets the database hide teammate emails
          // from direct browser-console queries.
          email: userEmail,
