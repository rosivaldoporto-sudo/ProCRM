            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-sm font-semibold text-foreground">{t(`templateNames.${slug}`)}</div>
                  <p className="mt-1 text-xs text-muted-foreground">{t(`templateDescs.${slug}`)}</p>
                </button>
              )
            })}
          </div>
